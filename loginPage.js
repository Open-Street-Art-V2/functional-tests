...
(async function example() {
  ...
  try {
    ...
    //click a second time on the zoom button (to display an art on the map)
    await driver
      .findElement(
        By.xpath(
          '//*[@id="root"]/div/div[1]/div/div[2]/div[1]/div/button[2]/span'
    ...
    console.log('artist name is displayed correctly !');
    ...
    console.log('location is displayed correctly !');
  } finally {
    await driver.quit();
  }
})();
